 ...
 * ============================================================
 * PERSONA
 * Ocupa el ancho completo para no crear una tercera fila rara.
 * ============================================================
 */
...
.fab-persona:hover:not(:disabled) {
  border-style:
    solid;
